      ...
      <div class="card card-stats">
        ...
        <div class="card-footer">
          <div class="stats">
            ...
            <a href="{{route('videos.index')}}" class="warning-link">Get More Videos...</a>
          </div>
        </div>
      </div>
    </div>
    <div class="col-xl-3 col-lg-6 col-md-6 col-sm-6">
      <div class="card card-stats">
        ...
        <div class="card-footer">
          <div class="stats">
            <i class="material-icons text-warning">warning</i>
            <a href="{{route('tags.index')}}" class="warning-link">Get More Tags...</a>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="card card-stats">
        ...
        <div class="card-footer">
          <div class="stats">
            ...
            <a href="{{route('tags.index')}}" class="warning-link"> 
                 More Tags
            </a>
          </div>
        </div>
